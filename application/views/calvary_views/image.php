                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                            <tr>
                                                <td><?=$i++?></td>
                                                <td><a class="btn btn-link btn-lg active" href="<?=site_url('manage-image-album/'.$album->id)?>"><?=$album->album_name;?></a></td>
                                                <td><?=$album->price;?></td>
                                                <td><?=$album->created_at;?></td>
                                                <td><a class="update_album" data-name="<?=$album->album_name;?>" data-price="<?=$album->price;?>" data-id="<?=$album->id;?>" href="#">Update</a> | <a href="<?=site_url('manage-image-album/'.$album->id)?>">manage</a></td>
                                            </tr>
                                    <?php }} ?>
                                    </tbody>
                                </table>
