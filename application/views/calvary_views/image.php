                                    ...
                                    <?php 
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a class="update_album" data-name="<?=$album->album_name;?>" data-price="<?=$album->price;?>" data-id="<?=$album->id;?>" href="#">Update</a> | <a href="<?=site_url('image/manage-image-album/'.$album->id)?>">manage</a></td>
                                            </tr>
                                    <?php }} ?>
                                    </tbody>
                                </table>
