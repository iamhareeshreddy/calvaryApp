                                    ...
                                    <?php 
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a class="update_album" data-name="<?=$album->album_name;?>" data-price="<?=$album->price;?>" data-album_cover="<?=base_url(VIDEO_ALBUM_PATH.'/'.$album->album_cover);?>" data-id="<?=$album->id;?>" href="#">Update</a> | <a href="<?=site_url('video/manage-video-album/'.$album->id)?>">manage</a></td>
                                            </tr>
                                    <?php }} ?>
                                    </tbody>
                                </table>
