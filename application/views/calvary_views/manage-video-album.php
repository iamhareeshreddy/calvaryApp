                                ...
                                <table id="album_list" class="table table-striped table-bordered">
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                            <tr>
                                                <td><?=$i++?></td>
                                                <td><?=$album->video_name;?></td>
                                                <td><?=$album->status==1?"Active":"In Active";?></td>
                                                <td><?=date("d-m-Y", strtotime($album->created_at));?></td>
                                                <td><a class="update_album" data-name="<?=$album->video_name;?>"  data-id="<?=$album->id;?>" href="#">Update</a> | <a href="#" id="remove_song" data-path="<?=$album->path;?>" data-id="<?=$album->id?>">Remove</a></td>
                                            </tr>
                                    <?php }} ?>
                                    </tbody>
                                </table>
    ...
    jQuery(document).ready(function()
    {
        ...
        jQuery("#remove_song").on("click", function()
        {
		    ...
		    function(isConfirm) 
		    {
		        if (isConfirm) 
		        {
		        	jQuery.post("<?=site_url("video/remove-file")?>", {"path": data.path, "song_id": data.id},function(res)
		        	{
